    ...
    function startPlugin() {    
        ...
        function initialize() {    
            ...
            function applyLeftMenu() {    
                ...
                // Застосовуємо сортування тільки для першої секції    
                if(sort.length) {    
                    sort.forEach((name) => {    
                ...
                // Застосовуємо приховування до ВСІХ пунктів меню з обох секцій    
            ...
            function applyTopMenu() {    
                ...
                // Спочатку видаляємо власні кнопки    
                $('.head__action.head__action--clear-cache, .head__action.head__action--reload').remove()    
    
                // ВИПРАВЛЕНО: Додаємо кнопку очищення кешу тільки якщо увімкнено    
                ...
                // Застосовуємо сортування та приховування    
                if(sort.length) {    
            ...
            // Початок функції для редагування верхнього меню    
            function editTopMenu() {    
                ...
                // ВИПРАВЛЕНО: Додаємо кнопку очищення кешу тільки якщо увімкнено в налаштуваннях    
                if (Lampa.Storage.get('add_clear_cache_button', false)) {    
                    let clearItem = $(`    
            ...
            function addSettings() {    
                ...
                // Новий параметр для кнопки перезавантаження    
                Lampa.SettingsApi.addParam({    
                    component: 'menu_editor',    
                    param: {    
                ...
                // ВИПРАВЛЕНО: Новий параметр для кнопки очищення кешу    
                Lampa.SettingsApi.addParam({    
                    component: 'menu_editor',    
                    param: {    
