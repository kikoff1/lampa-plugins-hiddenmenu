(function() {  
    ...
    function startPlugin() {  
        ...
        function initSettings() {  
            ...
            // Збираємо компоненти безпосередньо з DOM  
            $('.settings .settings-folder.selector').each(function() {  
        ...
        function start(type = 'menu') {  
            ...
            // Для налаштувань збираємо пункти прямо перед відкриттям  
            if(type === 'settings') {  
                initSettings()  
            }  
            ...
            current_items.forEach(function(item_orig) {  
                ...
                if(type === 'head') {  
                    // Для верхнього меню не показуємо підписи, тільки іконки  
                    item_title = ''  
                ...
                } else if(type === 'head' || type === 'settings') {  
                    if(item_icon && item_icon.length) {  
            ...
            Lampa.Modal.open({  
                ...
                onBack: () => {  
                    ...
                    if(active_controller) {  
                        Controller.toggle(active_controller)  
                    }  
                }  
            })  
        }  
        ...
        function orderHead() {  
            ...
            if (items.length) {  
                ...
                items.forEach((itemIndex) => {  
                    let el = head_items_map[itemIndex]  
        ...
        function hideHead() {  
            ...
            if (items.length) {  
                items.forEach((itemIndex) => {  
                    let el = head_items_map[itemIndex]  
                    if (el && el.length) el.addClass('hidden')  
                })  
            }  
        }  
        ...
        function save(type = 'menu') {  
            ...
            current_items.forEach(function(item, index) {  
                ...
                if(type === 'menu') {  
                    ...
                    // Для верхнього меню зберігаємо індекси  
                    sort.push(index)  
                } else if(type === 'settings') {  
