(function() {
    ...
    function startPlugin() {
        ...
        // ⚙️ Редагування меню налаштувань
        ...
        // ⚙️ Додаємо компонент у налаштування
        function addSettings() {
            ...
            Lampa.SettingsApi.addParam({
                ...
                onChange: function(value) {
                    if (value) {
                        $('<style id="hide_navigation_bar_style">.navigation-bar{display:none!important;}</style>').appendTo('head');
                    } else {
                        $('#hide_navigation_bar_style').remove();
                    }
                    Lampa.Storage.set('hide_navigation_bar', value);
                }
            });

            if (Lampa.Storage.field('hide_navigation_bar')) {
                $('<style id="hide_navigation_bar_style">.navigation-bar{display:none!important;}</style>').appendTo('head');
            }
        }
