(function() {      
    ...
    function startPlugin() {      
        ...
        // НОВІ ФУНКЦІЇ ДЛЯ ЗАВАНТАЖЕННЯ НАЛАШТУВАНЬ  
          
        // Функція для завантаження налаштувань лівого меню  
        ...
        // Функція для завантаження налаштувань верхнього меню  
            ...
            if(sort.length){  
                sort.forEach((className)=>{  
                    let item = $('.head__action').filter(function(){  
                        return $(this).attr('class').replace('head__action', '').trim() === className  
                    })  
        ...
        // Функція для завантаження налаштувань меню налаштувань  
...
// Функція для редагування лівого меню (всі пункти)    
        ...
        function addSettings() {      
            ...
            // КЛЮЧОВЕ ДОПОВНЕННЯ: Завантажуємо збережені налаштування  
            setTimeout(()=>{  
                loadLeftMenu()  
                loadTopMenu()  
            }, 500)  
        ...
        // Слухач для завантаження налаштувань меню налаштувань  
        Lampa.Listener.follow('activity', function(e){  
            if(e.type === 'start' && e.component === 'settings'){  
                setTimeout(loadSettingsMenu, 300)  
            }  
        })  
