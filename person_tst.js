(function() {
                    ...
                    new Lampa.Reguest().silent(url, function(response) {
                        try {
                            ...
                            if (json && json.id) {
                                ...
                                // Замість title, type, source ми використовуємо лише name та media_type,
                                // щоб Lampa коректно розпізнала картку як актора, а не фільм.
                                var personCard = {
                                    id: json.id,
                                    name: json.name,
    ...
    function startPlugin() {
        hideSubscribeButton(); // <-- Додаємо приховування кнопки
        Lampa.Lang.add({
