(function () {  
	...
	Lampa.Settings.listener.follow("open", function (e) {  
		if (e.name === "main") {  
			// Переконуємось, що переклади доступні  
			if (typeof t === 'function' && t("logos") !== "logos") {  
				Lampa.SettingsApi.addComponent({   
					component: C,   
					name: t("logos"),  
					icon: `<svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">  
						<rect x="2" y="8" width="32" height="20" rx="2" stroke="currentColor" stroke-width="2"/>  
						<circle cx="10" cy="18" r="2" fill="currentColor"/>  
						<path d="M14 16h8v4h-8z" fill="currentColor"/>  
						<path d="M24 14h6v8h-6z" fill="currentColor"/>  
					</svg>`  
				});  
